...
@interface PopPrivateView ()
@property (nonatomic, strong) UIView *superView;
@end

@implementation PopPrivateView
...
//    [self.superView addGestureRecognizer:tapView];
    ...
    UIButton *copyBtn = [Tool createButtonWithFrame:CGRectMake(35, 240,self.width-70, 40) title:NSLocalizedString(@"复制", nil) titleColor:CNavBgColor textFont:MYFONT(18) backgroudColor:nil target:self action:@selector(copyAction)];
