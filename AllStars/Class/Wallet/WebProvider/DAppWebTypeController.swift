...
extension DAppWebTypeController: CoinPayViewDelegate{
    func cancelAction() {
...
class DAppWebTypeController: JWBaseViewController {
...
//        return "0x914E99d483da28Dc8206773E9C664fd70581AA66"
    ...
    lazy var webview: WKWebView = {
        ...
        webview.backgroundColor = GSColor.bgColor.color
        return webview
    }()
...
extension DAppWebTypeController:WKNavigationDelegate{
    func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
        
    }
}

extension DAppWebTypeController: UITextFieldDelegate {
...
extension DAppWebTypeController: WKScriptMessageHandler {
...
//            handleSignMessage(id: id, data: data, addPrefix: false)
            ...
            if value == 0 || totalS.doubleValue>value{
                TRToast.toast(message: Bundle.mj_localizedString(forKey: "餘額不足", value: nil))
...
extension DAppWebTypeController: WKUIDelegate {
